...
partial struct BuildingConstructionSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach ((RefRO<LocalTransform> localTransform, RefRW<BuildingConstruction> buildingConstruction,
                     Entity entity) in SystemAPI
                     .Query<RefRO<LocalTransform>, RefRW<BuildingConstruction>>().WithEntityAccess())
        {
