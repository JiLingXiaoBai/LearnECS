...
public class AnimationDataHolderAuthoring : MonoBehaviour
{
    ...
    private class Baker : Baker<AnimationDataHolderAuthoring>
    {
        public override void Bake(AnimationDataHolderAuthoring authoring)
        {
                         ...
                         typeof(AnimationDataSO.AnimationType)))
            {
                ...
                BlobBuilderArray<BatchMeshID> blobBuilderArray =
                    blobBuilder.Allocate(ref animationDataBlobBuilderArray[index].batchMeshIdBlobArray,
            ...
            AddBlobAsset(ref animationDataHolder.animationDataBlobArrayBlobAssetReference, out Hash128 objectHash);
