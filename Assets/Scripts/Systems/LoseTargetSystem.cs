...
partial struct LoseTargetSystem : ISystem
{
    ...
    {
        foreach ((RefRO<LocalTransform> localTransform, RefRW<Target> target, RefRO<LoseTarget> loseTarget) in SystemAPI
                     .Query<RefRO<LocalTransform>, RefRW<Target>, RefRO<LoseTarget>>())
        {
